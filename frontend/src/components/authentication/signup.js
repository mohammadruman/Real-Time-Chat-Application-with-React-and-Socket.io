...
const Signup = () => {
    ...
    // loading is used to show the loading spinner when the user clicks on the signup button
 ...
 const PostDetails = (pics) => {
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("upload_preset", "socialworm");
      data.append("cloud_name", "dlbju22bl");
      fetch("https://api.cloudinary.com/v1_1/dlbju22bl/image/upload", {
        method: "post",
        body: data,
      })
        .then((res) => res.json())
